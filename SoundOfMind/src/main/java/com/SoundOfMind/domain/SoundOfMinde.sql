...
ALTER TABLE MEMBER_INFO DROP COLUMN ROOT
ALTER TABLE MEMBER_INFO ADD COLUMN ROOT VARCHAR(20) DEFAULT 'HOME'
ALTER TABLE MEMBER_INFO ADD COLUMN PROFILE VARCHAR(200) DEFAULT '2022/10/05/s_704b657c-072a-43a2-8118-b38e2491b774_cat2.jpg'
